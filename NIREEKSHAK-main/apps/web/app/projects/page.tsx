              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {canProposeProject(currentUser.role) && (
                  <button
                    ...
                    className="rounded-lg bg-emerald-600 hover:bg-emerald-500 px-3.5 py-2 text-xs font-semibold text-white transition shadow flex items-center gap-1.5"
                  >
                    <span>+</span>
                    <span>Propose Project</span>
                  </button>
                )}
                <div className="rounded-lg border border-slate-800 bg-[#101720] px-4 py-2 text-left md:text-right">
                  <p className="text-[10px] tracking-[0.2em] text-slate-600 uppercase">Total Records</p>
                  <p className="text-base font-bold text-white">{totalRecords.toLocaleString("en-IN")}</p>
                </div>
              </div>
            </div>
          </header>
    ...
    >
      ...
      <td className="px-6 py-5 text-right whitespace-nowrap">
        <button
          ...
          className="rounded-md border border-slate-700 bg-slate-800/40 px-2.5 py-1.5 text-[10px] font-medium tracking-wider text-slate-300 transition hover:bg-slate-700"
        >
          QUICK VIEW
        </button>
        <Link
          ...
          className="ml-2 rounded-md bg-emerald-600 hover:bg-emerald-500 px-3 py-1.5 text-[10px] font-bold tracking-wider text-white transition shadow"
        >
          DIGITAL FILE →
        </Link>
      </td>
